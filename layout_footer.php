...
<script>
    ...
    $(document).ready(function(){
            ...
            var fhtml = `<h2>Frontpage</h2>
            <div> 
            <img src="images/cars/bil0001.jpg" />
            </div>
            `;
            clearResponse();
            $('#content').html(fhtml);
        ...
        // submit form data to Authentication
        $.ajax({
            url: "Authentication/create_user.php",
            type : "POST",
        ...
        // submit form data to Authentication
        $.ajax({
            url: "Authentication/update_user.php",
            type : "POST",
            contentType : 'application/json',
            data : form_data,
            success : function(result) {
        ...
        // validate jwt to verify access
        var jwt = getCookie('jwt');
        $.post("Authentication/validate_token.php", JSON.stringify({ jwt:jwt })).done(function(result) {
